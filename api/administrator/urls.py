...
# App Utils
from administrator.views import CreateUserView, UpdateUserView, UpdateUserImageView, UpdateUserPasswordView, UsersListView, UserInfoView, DeleteUserView
...
urlpatterns = [
    ...
    path('users/<int:pk>/update-image', UpdateUserImageView.as_view(), name='update_user_image'),
